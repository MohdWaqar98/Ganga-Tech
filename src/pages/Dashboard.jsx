...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <div
        className="relative z-10 flex items-center justify-between p-3 animate-slideDown "
        style={{ width: "3" }}
      >
        {/* Location */}
      ...
      <div className="flex gap-2 justify-center fixed bottom-0 left-0 right-0 p-2">
        <button
          className={`text-white text-xl animate-fadeIn ${
