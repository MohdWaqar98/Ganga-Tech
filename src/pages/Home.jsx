        ...
        <>
          ...
          <div className="bg-white mx-6 p-6 pb-10   rounded-3xl text-center mb-6 relative z-10 animate-slideDown h-[20rem]">
            <div>
              ...
              <p className="text-black text-[18px]  pl-10 -mt-10 ">Today,{currentDate}</p>
              <h1 className="text-4xl font-bold  text-red-500">Severe</h1>
              <p className="text-black mt-1  text-[16px]">(Class E)</p>
              <p className="text-black px-2 mt-1 text-[14px]">Very poor quality, unsuitable for any direct use, requires extensive treatment.</p>
            </div>
            ...
            <div className='mt-2'>
              <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center justify-end w-1/2">
                  <span className="text-black text-[14px] font-semibold ">7.6 mg/L</span>
                </div>
              </div>
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2 w-1/2">
                  ...
                  <span className="text-black text-[14px] font-semibold ">B.O.D</span>
                </div>
                <div className="text-black">|</div>
                <div className="flex items-center justify-end w-1/2">
                  <span className="text-black text-[14px] font-semibold ">1.8 mg/L</span>
                </div>
              </div>
              <div className="flex items-center justify-between mb-2 ">
                <div className="flex items-center gap-2 w-1/2">
                  ...
                  <span className="text-black text-[14px] font-semibold ">pH</span>
                </div>
                <div className="text-black">|</div>
                <div className="flex items-center justify-end w-1/2">
                  <span className="text-black text-[14px] font-semibold ">7</span>
                </div>
              </div>
              <div className="flex items-center justify-between  mb-2">
                <div className="flex items-center gap-2 w-1/2">
                  ...
                  <span className="text-black text-[14px] font-semibold ">Total Coliform</span>
                </div>
                <div className="text-black">|</div>
                <div className="flex items-center justify-end w-1/2">
                  <span className="text-black text-[14px] font-semibold ">2194 MPN/100ml</span>
                </div>
              </div>
            </div>
          </div>
